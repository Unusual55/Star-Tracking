...
def extract_multiple_lines_and_save(inputfilename: str, iterations: int, max_distance: int, min_inliers_allowed: int):
    ...
    absolute_path = os.path.join(folder_script, "../../../Desktop/לימודים/אוניברסיטה/שנה ג/מבוא להנדסת חלל/src/images/",
                                 inputfilename)
    ...
    folder_script = os.path.dirname(__file__)
    file_result = os.path.join(folder_script, "../../../Desktop/לימודים/אוניברסיטה/שנה ג/מבוא להנדסת חלל/src/out/",
                               ("result-%s.png") % (filename_noextension))
...
extract_multiple_lines_and_save("Star_Images/Formatted/IMG_3053.jpg", iterations=30, max_distance=1, min_inliers_allowed=50)
